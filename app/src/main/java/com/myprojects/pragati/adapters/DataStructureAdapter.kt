...
class DataStructureAdapter(private val items: List<Websites>) :
    ...
    class DataStructureViewHolder(val binding: RecyclerviewSingleItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataStructureViewHolder {
        ...
        return DataStructureViewHolder(binding_)
    }
                        ...
                        val docRef = favoritesRef
                            .add(
                                mapOf(
                                    ...
                                    "filter" to "DataStructure" // add the new field "filter" here
                                )
                            )
                            .await()
