...
class FreelancingAdapter(private val items: List<Websites>) :
    RecyclerView.Adapter<FreelancingAdapter.FreelancingViewHolder>() {

    class FreelancingViewHolder(val binding: RecyclerviewSingleItemBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FreelancingViewHolder {
        val binding = RecyclerviewSingleItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return FreelancingViewHolder(binding)
    }
    ...
    override fun onBindViewHolder(holder: FreelancingViewHolder, position: Int) {
                        ...
                        val docRef = favoritesRef
                            .add(
                                mapOf(
                                    ...
                                    "filter" to "Freelancing" // add the new field "filter" here
                                )
                            )
                            .await()
