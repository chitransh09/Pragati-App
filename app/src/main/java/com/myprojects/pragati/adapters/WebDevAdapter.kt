...
class WebDevAdapter( private val items: List<Websites>) : RecyclerView.Adapter<WebDevAdapter.WebDevViewHolder>() {
    ...
    class WebDevViewHolder(val binding: RecyclerviewSingleItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WebDevViewHolder {
        ...
        return WebDevViewHolder(binding_)
    }
                        ...
                        val docRef = favoritesRef
                            .add(
                                mapOf(
                                    ...
                                    "filter" to "WebDevelopment" // add the new field "filter" here
                                )
                            )
                            .await()
