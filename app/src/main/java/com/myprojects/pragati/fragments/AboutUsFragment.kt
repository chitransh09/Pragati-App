...
class AboutUsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        (activity as AppCompatActivity).setSupportActionBar(binding.aboutUsToolbar)
...
//        (activity as AppCompatActivity).supportActionBar!!.title = "About Us"
        ...
        binding.aboutUsToolbar.navigationIcon?.setTintList(null) // Set the toolbar navigation icon to use the default color
